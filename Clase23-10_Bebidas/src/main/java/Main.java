...
public class Main {
    public static void main(String[] args) {
        ...
        int opcion = 0;
        //creo una variable de DrinkController para que si tengo el objeto DrinkController pueda acceder a todas sus funcionalidades (metodo consultarNombre)
        ...
        do {
            ...
            System.out.println("3. ¡Sorpréndeme! (Cóctel random)");
