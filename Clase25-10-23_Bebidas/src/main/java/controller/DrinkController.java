...
public class DrinkController {
    ...
    public void aleatorio() {
        ...
        try {
            ...
            ResponseDrinks responseDrinks = mapper.readValue(url, ResponseDrinks.class);
            //EN ESTE CASO RANDOM SOLO DEVUELVE 1, POR LO QUE PIDO QUE ME DEVUELVA LA PRIMERA
    ...
    /*public void guardarFavorito() {
        ObjectMapper mapper = new ObjectMapper();
        mapper.createParser(src/main/resources/favorito.json, ResponseDrinks.class);
